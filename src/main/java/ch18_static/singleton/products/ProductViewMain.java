...
//        ProductView productView2 = new ProductView(); // private 선언 후에는 오류 발생.
        ...
        // 생성자를 private처리를 했고, getInstance() 메서드 내에서
        // instance 정적변수가 null이라면 instance = new ProductView(); 하기로 정의했었기
        // 때문에 main단계에서 저희는 ProductView.getInstance();를 통해 객체를 생성합니다.
