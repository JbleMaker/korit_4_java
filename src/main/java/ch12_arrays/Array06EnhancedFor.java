...
/*
    ...
    일반 for문과의 차이점 :
        ...
        index 넘버의 사용 없이 바로 적용이 가능한 for 반복문이 있는데 이를 향상된
        for문이라고 한다.

        제약 :
            읽기만 되고, 쓰기가 안됩니다.
            예를 들어 1부터 100까지 추출하는건 되는데, 1부터 100까지 입력은 불가능할 때가 있다.

        형식 :
        for (자료형 변수명 : 반복가능한객체(배열)){
            반복실행문
        }
 */
...
//        }
    ...
    public static void main(String[] args) {
        ...
        //for문을 통해 1,2,3,4.... 200을 출력하시오.
        // 1부터 200까지 대입하시오.
        for ( int i = 0 ; i < numbers.length ; i++ ){
            numbers[i] = i+1;
        }

        String[] names = {"강미경", "김광호", "김규쳘", "김대웅", "김명규", "김민성", "김민효", "김서준", "김선영", "김선영", "김재원", "김종보", "김호섭", "노소정"
                            ,"염진우", "예영근","이수원", "이진혁", "정선유", "제다정"};

        //for문을 통해 이름을 강미경/ 김광호 / 김규철 ...으로 출력하시오.
        //printElem(배열) 형태로 메서드를 정의하시오. int, String배열에 다 사용할 수 있도록
        //method overloading도 적용.
