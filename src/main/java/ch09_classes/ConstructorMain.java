...
public class ConstructorMain {
    public static void main(String[] args) {
        ...
        // String 매개변수 생성자를 통한 객체생성
        Constructor constructor3 = new Constructor("생성자");
        // 이상의 경우 만들 때 속성값을 바로 초기화
        constructor3.num =23;
        //이상의 경우는 default로 0으로 초기화되었을 거기 때문에
        //23을 '재대입' 했다고 해석할 수 있습니다.

        //AllArgsConstructor를 기준으로 두 개의 객체를 생성.
        Constructor constructor4 = new Constructor(24, "new");
        Constructor constructor5 = new Constructor("new", 25);
