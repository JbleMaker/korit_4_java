...
public class Car {
    /*
        ...
        3. displayInfo()결과값
            : 이 차의 색깔은 빨강색이고,
              최고 속도는 100km/h입니다. 그냥저냥입니다. -> 이 뒷 부분을 if문으로 작성.

              이 차의 색깔은 노랑색이고,
              최고 속도는 200km/h입니다. 빠릅니다. -> 100이하면 그냥저냥 100초과면
                                                    빠릅니다가 출력하도록 메서드 정의

        다 작성하시면 car1의 색깔 빨강/속도 100으로 생성
        car2의 색깔 노랑/ 속도 200으로 생성한 후
        각각 drive()/brake()/displayInfo()를 실행하시고, 콘솔창에 결과를 출력하시오.
     */
    static String color;
    static int speed;
    ...
    public static void drive() {
        ...
        System.out.println("최고속도는 " + speed + "입니다.");
    }
    public String brake() {
       return " 자동차가 멈췄습니다.";
    }
