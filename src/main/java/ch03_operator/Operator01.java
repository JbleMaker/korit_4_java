...
public class Operator01 {
    public static void main(String[] args) {
        ...
        // '='
        /*
            대입 연산자는 = : = 오른쪽에 있는 데이터를 = 왼쪽에 있는 변수에 '대입한다는 의미'로,
                변수와 데이터가 동일하다는 수학적인 의미가 아닙니다.
         */
        int i2 = 20;
        i2 = i2 + 30; // 왼쪽과 오른쪽이 같다고 표시할때는 ==
...
//        System.out.println(j);          // 다시 j를 출력시켰을 때 1증가
//        System.out.println(++j);        // ++변수명 : 코드를 실행시키기 전에 j에 1을 더함
//        System.out.println(j);          // 결과값 12
//        System.out.println(j--);        // 변수명-- : 코드를 실행시킨 후 j에 1을 뺌.
//        System.out.println(j);
//        System.out.println(--j);        //--변수명 : 코드를 실행시키 전에 j에 1을 뺌.
