...
//        거기서 오류가 하나라도 발생하면 전체 프로그램이 실행되지 않는다.
//        하지만 주석 처리를 한 부분에 대해서는 컴퓨터가 코드로 인지하지 않기 때문에
//        오류가 발생하지 않습니다.
//
//        즉, 주석이란 컴퓨터가 읽어서 처리하는 부분이 아니라 사람이 읽어서 정보를 얻을 수 있는데에
//        의의가 있습니다.
//
//        1) 한 줄 주석: //
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 김종보입니다.");
//        System.out.println(안녕하세요, 제 이름은 김종보입니다.); -> 오류 발생
        ...
        */
        ...
        String introduction = "안녕하세요. 저는 Java를 배우게 된 김종보입니다.";
        System.out.println(introduction + " 앞으로 잘부탁드리겠습니다.");
        ...
        /*
            ...
            그렇기 때문에 저희는 해당 라인에서 sout()의 () 안에 ""를 넣어줌으로써,
            () 내부가 전체적으로 문자"열"로 인식 되도록 꼼수를 부렸다고 할 수 있습니다.
        ...
        */
        ...
        int width1 = 100;
        int width2 = 200;
        System.out.println(width1 + width2); // 300 숫자끼리는 연산이 가능
...
//        int pi2 = 3.14;
        ...
        /*
            Java에서의 변수 표기 방식 :
                ...
                ch) 파이썬 학습하신분들은 파이썬의 변수 표기 방식은 snake case라고 해서
        ...
        String name = "김종보";
        String major = "정보통신";
        String currentJob = "코리아 it 아카데미 국비 교육생";
        String previousJob = "프리랜서 강사";
        ...
        // 선언한 변수들을 본인에게 적합한 데이터로 '초기화' 하여
        // 저는 코리아 it 아카데미 4월 국비 과정을 수강하고 있는 ()입니다. ???살입니다.
        ...
        System.out.println("저는 코리아 it 아카데미 4월 국비 과정을 수강하고 있는 " + name4 + "입니다. " + age4 + "살입니다.\n" +
                "제 전공은 " + major4 + "학과이며, mbti는 " + mbti4 + "입니다. 열심히 할께요!!");
