...
public class Tiger extends Animal{ //(자식) 클래스명 extends (부모) 클래스명
    ...
    public Tiger(String animalName, int animalAge, boolean striped) {
        ...
        this.striped = striped;             // 자식 고유 필드를 창조하는 기존의 코드 작성 방식
    }
    ...
    @Override
    public void move() {
        super.move();       // md파일에서 작성한 super 키워드 = 상위의 클래스
        //super는 부모클래스의 객체를 의미함.
        // 즉 이상의 코드는 부모클래스인 Animal클래스의 move() 메서드를 호출한다는 의미.
